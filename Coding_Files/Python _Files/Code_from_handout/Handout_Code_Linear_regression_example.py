...
# The following is by copying the code given at https://towardsdatascience.com/linear-regression-using-least-squares-a4c3456e8570
# and replacing the parameters with our own
...
# The following block is an attempt to code the 
